...
static int sc640_spm_get_sensor_capbility(int32_t capArraySize, SENSOR_CAPABILITY_S* sensor_capability)
{
    ...
    sensor_capability->snr_config_num = SC640_SPM_WORK_MODE_SIZE;
    sensor_capability->snr_config[SC640_SPM_640x512_8bit_LINEAR_60_2LANE].width = 640;
    sensor_capability->snr_config[SC640_SPM_640x512_8bit_LINEAR_60_2LANE].height = 512;
    sensor_capability->snr_config[SC640_SPM_640x512_8bit_LINEAR_60_2LANE].bitDepth = 8;
    sensor_capability->snr_config[SC640_SPM_640x512_8bit_LINEAR_60_2LANE].maxFps = 60;
    sensor_capability->snr_config[SC640_SPM_640x512_8bit_LINEAR_60_2LANE].minFps = 5;
    sensor_capability->snr_config[SC640_SPM_640x512_8bit_LINEAR_60_2LANE].image_mode = SENSOR_LINEAR_MODE;
    sensor_capability->snr_config[SC640_SPM_640x512_8bit_LINEAR_60_2LANE].lane_num = 2;
    sensor_capability->snr_config[SC640_SPM_640x512_8bit_LINEAR_60_2LANE].pattern = ISP_BAYER_PATTERN_MONO;
    sensor_capability->snr_config[SC640_SPM_640x512_8bit_LINEAR_60_2LANE].supportPDAF = 0;
    sensor_capability->snr_config[SC640_SPM_640x512_8bit_LINEAR_60_2LANE].work_mode =
        SC640_SPM_640x512_8bit_LINEAR_60_2LANE;
    sensor_capability->snr_config[SC640_SPM_640x512_8bit_LINEAR_60_2LANE].setting = &sc640_spm_setting;
...
static int sc640_spm_get_sensor_work_info(int32_t work_mode, SENSOR_WORK_INFO_S* snr_info)
{
    ...
    switch (work_mode) {
        case SC640_SPM_640x512_8bit_LINEAR_60_2LANE:
            snr_info->linetime = SC640_LINETIME_512P60_8bit_LINEAR;
            snr_info->vts = SC640_VMAX_512P60_8bit_LINEAR;
            ...
            snr_info->setting_table = sc640_spm_640x512_8bit_60fps_tab;
