...
// return    : int
//
#define cjson_get_int(item) ((int)((item)->valueint))
#define cjson_get_str(item) ((char *)((item)->valuestring))
...
extern void cJSON_AddItemToObjectCS(
    ...
    cJSON
        *item); /* Use this when string is definitely const (i.e. a literal, or
                   as good as), and will definitely survive the cJSON object */
