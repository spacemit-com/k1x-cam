 ...
 * All Rights Reserved.
 * *****************************************************************************
 * File Name     : asr_isp_comm.h
 * Description   : define data types which are used by external.
 */

#ifndef __ASR_ISP_COMM_H__
#define __ASR_ISP_COMM_H__
...
typedef struct asrISP_OFFLINE_ATTR_S {
...
typedef struct asrISP_TUNING_ATTRS_S {
...
typedef enum asrISP_SENSITIVITY_MODE_E {
...
typedef enum asrISP_SENSOR_EXPOSURE_MODE_E {
...
typedef enum asrISP_AWB_MODE_E {
    ISP_AWB_MODE_AUTO,
    ISP_AWB_MODE_MANUAL,
    ISP_AWB_MODE_SHADE,
...
typedef enum asrISP_AF_STATUS_E {
    ISP_AF_STATUS_IDLE,
...
typedef enum asrISP_ANTIFLICKER_MODE_E {
...
typedef enum asrISP_LSC_MODE_E {
    ISP_LSC_MODE_AUTO,
    ISP_LSC_MODE_MANUAL,
    ISP_LSC_MODE_INVALID,
} ISP_LSC_MODE_E;

typedef enum asrISP_CCM_MODE_E {
    ISP_CCM_MODE_AUTO,
    ISP_CCM_MODE_MANUAL,
    ISP_CCM_MODE_INVALID,
} ISP_CCM_MODE_E;

typedef struct asrISP_REGION {
    int32_t start_x;
    int32_t start_y;
    int32_t end_x;
    int32_t end_y;
...
typedef struct asrISP_MANUAL_AE_INFO_S {
    int32_t exposure;           // us
...
typedef struct asrISP_AE_INFO_S {
    ISP_AE_MODE_E aeMode;
    ISP_MANUAL_AE_INFO_S *pstManualAe;
} ISP_AE_INFO_S;

typedef struct asrISP_MANUAL_AWB_INFO_S {
...
typedef struct asrISP_METERING_INFO_S {
